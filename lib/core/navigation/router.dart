...
final GoRouter router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: AppConstants.routeLibrary, builder: (context, state) => const LibraryScreen()),
    GoRoute(path: AppConstants.routeCollections, builder: (context, state) => const CollectionsScreen()),
    GoRoute(path: AppConstants.routeBrowse, builder: (context, state) => const BrowseScreen()),
    ...
    GoRoute(path: AppConstants.routeStatistics, builder: (context, state) => const StatisticsScreen()),
    GoRoute(path: AppConstants.routeSettings, builder: (context, state) => const SettingsScreen()),
    GoRoute(path: "$AppConstants.routeReader/:bookId", builder: (context, state) {
      final bookId = state.pathParameters["bookId"] ?? "";
      return ReaderScreen(bookId: bookId);
    }),
    GoRoute(path: "$AppConstants.routeBookDetail/:bookId", builder: (context, state) {
      final bookId = state.pathParameters["bookId"] ?? "";
